...
professional_responses = ["Your satisfaction is my top priority; feel free to reach out if there's anything else I can help you with.", 
                          "I'm at your service for any additional questions or support you may not hesitate to ask.",]
...
def Content(Topic):
    ...
    def ContentWriterAI(prompt):
        ...
        Answer=Answer.replace().replace("</s>","")
    ...
    try:
        ...
        def search_google(query):
            ...
            if response.status_code == 200:
                ...
                print("Failed to retrieve search response")
            return None
